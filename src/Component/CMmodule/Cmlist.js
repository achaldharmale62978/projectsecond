            ...
            <div className='col-12'>
              ...
              <div className='table-responsive'>
                <table className='table table-striped table-bordered'>
                  <thead>
                    <tr>
                      <th scope="col" className="table-secondary">Rid</th>
                      <th scope="col">First Name</th>
                      <th scope="col" className="table-secondary">Last Name</th>
                      <th scope="col">Birth Date</th>
                      <th scope="col" className="table-secondary">Phone No.</th>
                  ...
                  <tbody>
                    {reg.map(usee => (
                      <tr key={usee.rid}>
                        <th className="table-secondary">{usee.rid}</th>
                        <td>{usee.bfname}</td>
                        <td className="table-secondary">{usee.blname}</td>
                        <td>{usee.bbdate}</td>
                        <td className="table-secondary">{usee.bphnum}</td>
                        <td>{usee.bemail}</td>
                        <td className="table-secondary">{usee.badd}</td>
                        <td>{usee.bgender}</td>
                      </tr>
                    ))}
                  </tbody>
